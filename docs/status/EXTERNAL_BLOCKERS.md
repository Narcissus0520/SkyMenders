...
Last reviewed on 2026-07-26. Engineering release controls, content
...
| ------- | ------------------------------- | ------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| EXT-001 | Product owner                   | WeChat Mini Game AppID, verified operating entity and Cocos engine-plugin authorization          | Credentials installed through secret store; platform login and optimized plugin-runtime tests pass without client secret exposure | 5, 7, 11         |
...
Local progress on 2026-07-26 does not close these blockers: Cocos Creator
...
were confirmed with the earlier self-contained build. The optimized
1,876,241-byte generated directory passes the repository's internal budget, but
the sandbox AppID cannot load the Cocos public engine plugin. No product-owned
AppID, verified operating entity, upload, physical-device report or current
official package-limit record was supplied.
