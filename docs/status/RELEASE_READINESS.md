...
| No open P0/P1                                  | Release preflight parses `KNOWN_ISSUES.md`                          | Blocked: compiled package issue `PKG-001` is open                      |
...
| Real WeChat package and current limits         | Compiled-package analyzer plus dated official evidence              | Local test build exists; blocked by `PKG-001`, `EXT-001`, `EXT-006`    |
